...
description: "ViewModel best practices: StateFlow для UI state, SharedFlow для one-off events. Триггеры: ViewModel, StateFlow, SharedFlow, UI state, state management, MVVM."
---
