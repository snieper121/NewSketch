---
name: coil-compose
description: "Coil для загрузки изображений в Jetpack Compose: AsyncImage, rememberAsyncImagePainter, SubcomposeAsyncImage. Триггеры: Coil, image loading, AsyncImage, image URL, painter, загрузка изображений."
---
