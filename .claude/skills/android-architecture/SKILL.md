...
description: "Современная архитектура Android: Clean Architecture, Hilt DI, модулизация. Триггеры: architecture, project structure, module setup, dependency injection, Hilt, Clean Architecture."
---
