...
description: "Стратегия тестирования Android: Unit, Integration, Hilt, Screenshot тесты. Триггеры: testing, unit test, integration test, screenshot test, Roborazzi, Hilt testing, test strategy."
---
...
*   **Unit**: `./gradlew test`
*   **Screenshots**: `./gradlew recordRoborazziDebug` (record) / `./gradlew verifyRoborazziDebug` (verify)
