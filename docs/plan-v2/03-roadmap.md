...
Оценки умножены × 1.5-2 для solo dev с учётом research, debugging, рефакторинга.
...
## Таймлайн (реалистичный, solo dev)
...
**33-50 недель (7-12 месяцев)** до beta-ready MVP.

Не забывать про buffer:
- Research (Compose internals, kotlinc args) — учтено в M0
- Rewrites при архитектурных ошибках — учтено в буфере
- Integration bugs — учтено
- Personal factors (болезнь, отпуск) — **дополнительно 10-15%**

**Реалистичный coarse estimate:** 10-14 месяцев до v1.0 stable для solo full-time dev.
